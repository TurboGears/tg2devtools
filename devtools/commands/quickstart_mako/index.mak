...
<%def name="title()">
  ...
  <div class="row">
    ...
    <div class="span4">
      <a class="btn btn-small" href="http://turbogears.readthedocs.org/en/latest">${h.icon('book')} TG2 Documents</a> <span class="label label-success">new</span> Read the Getting Started section<br/>
        <br/>
      <a class="btn btn-small" href="http://turbogears.readthedocs.org/en/latest/cookbook/cookbook.html">${h.icon('book')} TG2 CookBook</a> Read the Cookbook<br/>
        <br/>
